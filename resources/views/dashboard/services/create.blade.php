...
@section('page-title', 'Create New IT Service')
        ...
        <form action="{{ route('dashboard.services.store') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <textarea name="description" rows="4" 
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" 
                    placeholder="Brief description of the service" required>{{ old('description') }}</textarea>
                @error('description')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-6">
                ...
                <input type="text" name="icon" value="{{ old('icon', 'fas fa-laptop-code') }}" 
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" 
