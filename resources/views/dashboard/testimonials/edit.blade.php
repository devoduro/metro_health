        ...
        <form action="{{ route('dashboard.testimonials.update', $testimonial) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <textarea name="content" rows="5" 
                    ...
                    placeholder="What did the client say about your service?" required>{{ old('content', $testimonial->content) }}</textarea>
                @error('content')
            ...
            <div class="mb-6">
                ...
                <input type="text" name="client_organization" value="{{ old('client_organization', $testimonial->client_organization) }}" 
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" 
