...
<head>
    ...
    <title>Admin Login | Metro Health</title>
            ...
            <div class="col-md-5">
                <div class="admin-login-card">
                    <div class="text-center mb-4">
                        <img src="{{ asset('images/2026-01-12-J8o94jxc.png') }}" alt="Ashlocs Logo" style="height: 80px; margin-bottom: 1.5rem;">
                    ...
                    <div class="text-center mt-4">
                        <a href="{{ route('home') }}" style="color: var(--ashlocs-orange); text-decoration: none;">
