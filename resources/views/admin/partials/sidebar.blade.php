<div class="admin-sidebar">
    <div class="sidebar-header">
        <img src="{{ asset('images/2026-01-12-J8o94jxc.png') }}" alt="Ashlocs Logo" style="height: 50px; margin-bottom: 10px;">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="{{ route('admin.bookings') }}" class="sidebar-link {{ request()->routeIs('admin.bookings') ? 'active' : '' }}">
            ...
            <span class="badge bg-warning ms-auto">{{ $pending_bookings }}</span>
            @endif
        </a>
