...
<head>
    ...
    <title>Edit Service | Metro Health Admin</title>
        ...
        <div class="container-fluid p-4">
            <div class="admin-card">
                <div class="admin-card-header">
                    <h5><i class="fas fa-edit me-2"></i>Edit Service: {{ $service->title }}</h5>
                    ...
                    <form action="{{ route('admin.services.update', $service) }}" method="POST">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="price_min" class="form-control form-control-lg" step="0.01" min="0" value="{{ old('price_min', $service->price_min) }}" placeholder="0.00">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="price_max" class="form-control form-control-lg" step="0.01" min="0" value="{{ old('price_max', $service->price_max) }}" placeholder="0.00">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="icon" class="form-control" value="{{ old('icon', $service->icon) }}" placeholder="fas fa-cut">
