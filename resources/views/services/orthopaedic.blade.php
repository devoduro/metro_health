...
<body>
                ...
                <div class="col-lg-8" data-aos="fade-right">
                    <div class="service-detail-content">
                        ...
                        <div class="service-image mb-5" style="border-radius: 25px; overflow: hidden; box-shadow: 0 20px 50px rgba(0, 0, 0, 0.15); position: relative;">
                            <img src="{{ asset('images/services/rehab-736x453.png') }}" 
   ...
   <!-- Additional Service Image -->
                        <div class="service-image mt-5 mb-5" style="border-radius: 25px; box-shadow: 0 20px 50px rgba(0, 0, 0, 0.15);">
                            <img src="{{ asset('images/services/orthoped.jpg') }}" 
                ...
                <div class="col-lg-4" data-aos="fade-left">
                    ...
                    <div class="services-menu mb-4" style="background: white; border-radius: 20px; padding: 30px; box-shadow: 0 5px 20px rgba(0, 0, 0, 0.08);">
                        ...
                        <div class="services-list">
                            ...
                            <a href="{{ route('services.orthopaedic') }}" class="service-link active" style="display: flex; align-items: center; padding: 12px 15px; margin-bottom: 8px; border-radius: 10px; text-decoration: none; background: #f3e5f5; border-left: 3px solid #a8207a; transition: all 0.3s ease;">
