        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-6 mb-4 mb-lg-0">
                ...
                <div style="display: flex; flex-direction: column; gap: 10px;">
                    ...
                    <a href="<?php echo e(route('services.neurology-neurosurgery')); ?>" style="color: rgba(255, 255, 255, 0.7); text-decoration: none; font-size: 0.9rem; transition: all 0.3s ease; display: block;">Neurology & Neurosurgery</a>
