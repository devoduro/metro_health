                        ...
                        <div class="row align-items-center">
                            <div class="col-md-4 text-center mb-4 mb-md-0">
                                <div style="background: white; padding: 30px; border-radius: 15px; box-shadow: 0 5px 20px rgba(0, 0, 0, 0.08);">
                                    <img src="<?php echo e(asset('images/brands/stanbic-bank-logo.png')); ?>" alt="Stanbic Bank" style="max-width: 100%; height: auto;" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
            ...
            <div class="row">
                <div class="col-lg-8 mx-auto text-center" data-aos="fade-up">
                    ...
                    <div class="d-flex gap-3 justify-content-center flex-wrap">
                        <a href="<?php echo e(route('contact')); ?>" class="btn-cta">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/metrohealth/resources/views/businesses-organizations.blade.php ENDPATH**/ ?>