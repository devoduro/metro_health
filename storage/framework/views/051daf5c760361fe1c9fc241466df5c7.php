                ...
                <div class="col-lg-4" data-aos="fade-left">
                    ...
                    <div class="services-menu mb-4" style="background: white; border-radius: 20px; padding: 30px; box-shadow: 0 5px 20px rgba(0, 0, 0, 0.08);">
                        ...
                        <div class="services-list">
                            ...
                            <a href="<?php echo e(route('services.neurology-neurosurgery')); ?>" class="service-link active" style="display: flex; align-items: center; padding: 12px 15px; margin-bottom: 8px; border-radius: 10px; text-decoration: none; background: #f3e5f5; border-left: 3px solid #a8207a; transition: all 0.3s ease;">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/metrohealth/resources/views/services/neurology-neurosurgery.blade.php ENDPATH**/ ?>