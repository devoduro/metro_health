...
<body>
                    ...
                    <div class="welcome-content">
                        ...
                        <div class="welcome-features-wrapper">
                            ...
                            <div class="team-image-small">
                                <img src="<?php echo e(asset('images/about/welcome.png')); ?>" alt="Medical Team">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-4 mb-5">
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                    <div class="medical-service-card">
                        ...
                        <div class="service-card-image">
                            <img src="<?php echo e(asset('images/services/general-pra-1.png')); ?>" alt="General Practice">
                        </div>
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500">
                    <div class="medical-service-card">
                        ...
                        <div class="service-card-image">
                            <img src="<?php echo e(asset('images/services/wee-1.png')); ?>" alt="Neurology & Neurosurgery">
                        </div>
                        <div class="service-card-body">
    ...
    <section class="news-articles-section section-padding">
        <div class="container">
            ...
            <div class="text-center" data-aos="fade-up">
                <a href="<?php echo e(route('news-update.index')); ?>" class="btn-view-all-articles">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="cta-actions">
                        <a href="<?php echo e(route('contact')); ?>" class="btn-contact-now">
                            CONTACT US NOW
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 mb-4 mb-lg-0">
                    <img src="<?php echo e(asset('images/2026-01-12-J8o94jxc.png')); ?>" alt="Ashlocs Logo" class="footer-logo mb-3">
                ...
                <div class="col-lg-2 col-6 mb-4 mb-lg-0">
                    ...
                    <a href="<?php echo e(route('services.index')); ?>" class="footer-link">Services</a>
                ...
                <div class="col-lg-2 col-6 mb-4 mb-lg-0">
                    ...
                    <?php if($service->slug): ?>
                    <a href="<?php echo e(route('services.show', $service->slug)); ?>" class="footer-link"><?php echo e($service->title); ?></a>
                    <?php endif; ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                <div class="col-lg-4">
