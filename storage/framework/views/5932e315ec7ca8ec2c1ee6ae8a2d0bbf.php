            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                                ...
                                <div class="col-md-6">
                                    <div style="position: relative; height: 100%; min-height: 350px;">
                                        <?php if($featuredPost->image): ?>
                                            <img src="<?php echo e(asset('storage/' . $featuredPost->image)); ?>" alt="<?php echo e($featuredPost->title); ?>" style="width: 100%; height: 100%; object-fit: cover;" onerror="this.src='https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=800'">
                                        <?php else: ?>
                                            <img src="https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=800" alt="<?php echo e($featuredPost->title); ?>" style="width: 100%; height: 100%; object-fit: cover;">
                                        <?php endif; ?>
                                    ...
                                    <div style="padding: 35px;">
                                        <div style="display: flex; align-items: center; gap: 15px; margin-bottom: 15px;">
                                            <span style="color: #84a33f; font-weight: 600; font-size: 0.9rem;">
                                                <i class="far fa-calendar me-2"></i><?php echo e($featuredPost->published_at ? $featuredPost->published_at->format('M d, Y') : 'Recent'); ?>

                                            </span>
                                            <span style="color: #999;">•</span>
                                            <span style="color: #666; font-size: 0.9rem;">
                                                <i class="far fa-user me-2"></i><?php echo e($featuredPost->author ?? 'Admin'); ?>

                                            </span>
                                        </div>
                                        <h2 style="font-size: 1.8rem; font-weight: 700; color: #1a1a1a; margin-bottom: 15px; line-height: 1.3;"><?php echo e($featuredPost->title); ?></h2>
                                        <p style="color: #666; font-size: 0.95rem; line-height: 1.7; margin-bottom: 20px;"><?php echo e(Str::limit($featuredPost->excerpt ?? $featuredPost->content, 150)); ?></p>
                                        <a href="<?php echo e(route('news-update.show', $featuredPost->slug)); ?>" class="btn" style="background: #a8207a; color: white; padding: 12px 30px; border-radius: 8px; font-weight: 600; text-decoration: none; display: inline-block;">
                    ...
                    <div class="recent-articles">
                        ...
                        <div class="row g-4">
                            <?php if(isset($posts) && $posts->count() > 1): ?>
                                ...
                                <div class="col-md-6" data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 100); ?>">
                                    <article style="background: white; border-radius: 15px; overflow: hidden; box-shadow: 0 3px 15px rgba(0, 0, 0, 0.08); transition: all 0.3s ease; height: 100%;" onmouseover="this.style.transform='translateY(-5px)'; this.style.boxShadow='0 8px 25px rgba(0, 0, 0, 0.12)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 3px 15px rgba(0, 0, 0, 0.08)'">
                                        <div style="position: relative; height: 220px; overflow: hidden;">
                                            <?php if($post->image): ?>
                                                <img src="<?php echo e(asset('storage/' . $post->image)); ?>" alt="<?php echo e($post->title); ?>" style="width: 100%; height: 100%; object-fit: cover;" onerror="this.src='https://images.unsplash.com/photo-1505751172876-fa1923c5c528?w=800'">
                                            <?php else: ?>
                                                <img src="https://images.unsplash.com/photo-<?php echo e(['1505751172876-fa1923c5c528', '1576091160399-112ba8d25d1d', '1519494026892-80bbd2d6fd0d', '1584820927498-cfe5211fd8bf'][$loop->index % 4]); ?>?w=800" alt="<?php echo e($post->title); ?>" style="width: 100%; height: 100%; object-fit: cover;">
                                            <?php endif; ?>
                                            <div style="position: absolute; bottom: 15px; left: 15px;">
                                                <span style="background: rgba(255, 255, 255, 0.95); color: #a8207a; padding: 6px 15px; border-radius: 20px; font-weight: 600; font-size: 0.8rem;">
                                                    <?php echo e($post->published_at ? $post->published_at->format('M d, Y') : 'Recent'); ?>

                                                </span>
                                            </div>
                                        </div>
                                        <div style="padding: 25px;">
                                            <h4 style="font-size: 1.2rem; font-weight: 700; color: #1a1a1a; margin-bottom: 12px; line-height: 1.4;"><?php echo e(Str::limit($post->title, 60)); ?></h4>
                                            <p style="color: #666; font-size: 0.9rem; line-height: 1.6; margin-bottom: 15px;"><?php echo e(Str::limit($post->excerpt ?? $post->content, 100)); ?></p>
                                            <div style="display: flex; align-items: center; justify-content: space-between; padding-top: 15px; border-top: 1px solid #eee;">
                                                <span style="color: #999; font-size: 0.85rem;">
                                                    <i class="far fa-user me-1"></i><?php echo e($post->author ?? 'Admin'); ?>

                                                </span>
                                                <a href="<?php echo e(route('news-update.show', $post->slug)); ?>" style="color: #a8207a; font-weight: 600; text-decoration: none; font-size: 0.9rem;">
                ...
                <div class="col-lg-4" data-aos="fade-left">
                    ...
                    <div class="sidebar-widget mb-4" style="background: white; border-radius: 15px; padding: 30px; box-shadow: 0 3px 15px rgba(0, 0, 0, 0.08);">
                        ...
                        <form action="<?php echo e(route('news-update.index')); ?>" method="GET">
                    ...
                    <div class="sidebar-widget mb-4" style="background: white; border-radius: 15px; padding: 30px; box-shadow: 0 3px 15px rgba(0, 0, 0, 0.08);">
                        ...
                        <div style="display: flex; flex-direction: column; gap: 20px;">
                            <?php if(isset($posts) && $posts->count() > 0): ?>
                                <?php $__currentLoopData = $posts->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recentPost): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div style="display: flex; gap: 15px;">
                                    <div style="flex-shrink: 0; width: 70px; height: 70px; border-radius: 10px; overflow: hidden;">
                                        <?php if($recentPost->image): ?>
                                            <img src="<?php echo e(asset('storage/' . $recentPost->image)); ?>" alt="<?php echo e($recentPost->title); ?>" style="width: 100%; height: 100%; object-fit: cover;" onerror="this.src='https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=200'">
                                        <?php else: ?>
                                            <img src="https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=200" alt="<?php echo e($recentPost->title); ?>" style="width: 100%; height: 100%; object-fit: cover;">
                                        <?php endif; ?>
                                    </div>
                                    <div style="flex: 1;">
                                        <a href="<?php echo e(route('news-update.show', $recentPost->slug)); ?>" style="color: #1a1a1a; text-decoration: none; font-weight: 600; font-size: 0.9rem; line-height: 1.4; display: block; margin-bottom: 5px;"><?php echo e(Str::limit($recentPost->title, 50)); ?></a>
                                        <span style="color: #999; font-size: 0.8rem;">
                                            <i class="far fa-calendar me-1"></i><?php echo e($recentPost->published_at ? $recentPost->published_at->format('M d, Y') : 'Recent'); ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/metrohealth/resources/views/news-articles.blade.php ENDPATH**/ ?>