...
<body>
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center text-center">
                <div class="col-lg-8" data-aos="fade-up">
                    ...
                    <h1 class="display-3 fw-bold mb-4" style="color: var(--ashlocs-dark);"><?php echo e($service->title); ?></h1>
            ...
            <div class="row g-5">
                    ...
                    <div class="service-detail-content">
                        ...
                        <div class="service-image mb-5" style="border-radius: 25px; overflow: hidden; box-shadow: 0 20px 50px rgba(0, 0, 0, 0.15); position: relative;">
                            ...
                            <div style="position: absolute; bottom: 0; left: 0; right: 0; background: linear-gradient(to top, rgba(0,0,0,0.8) 0%, transparent 100%); padding: 30px; color: white;">
                                <h3 style="font-size: 1.8rem; font-weight: 700; margin-bottom: 10px; color: white;"><?php echo e($imageTitle); ?></h3>
                                <p style="font-size: 1.1rem; margin: 0; opacity: 0.9;"><?php echo e($imageSubtitle); ?></p>
                            </div>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="content-text" style="font-size: 1.1rem; line-height: 1.8; color: var(--ashlocs-gray);">
                            <?php echo nl2br(e($service->full_description ?? $service->description)); ?>

                        </div>

                        <?php if(str_contains($slug, 'training') || str_contains($slug, 'workshop')): ?>
                        ...
                        <?php if(str_contains($slug, 'dreadlock') || str_contains($slug, 'loc')): ?>
                        ...
                        <?php if(str_contains($slug, 'haircut') || str_contains($slug, 'cut')): ?>
                        ...
                        <?php if(str_contains($slug, 'braid') || str_contains($slug, 'cornrow')): ?>
                        ...
                        <div class="pricing-section mt-5 p-4" style="background: var(--ashlocs-light); border-radius: 20px; border-left: 5px solid var(--ashlocs-orange);">
                            ...
                            <p class="mb-0" style="font-size: 2.5rem; font-weight: 800; color: var(--ashlocs-orange);"><?php echo e($service->price); ?></p>
                        </div>
                        <?php endif; ?>
                ...
                <div class="col-lg-4" data-aos="fade-left">
                    ...
                    <div class="booking-card" style="background: white; border-radius: 25px; padding: 2.5rem; box-shadow: 0 20px 50px rgba(0, 0, 0, 0.1); position: sticky; top: 100px;">
                        ...
                        <a href="<?php echo e(route('booking.index')); ?>?service=<?php echo e($service->id); ?>" class="btn btn-primary-custom btn-lg w-100 mb-3">
                            <i class="fas fa-calendar-check me-2"></i>Book an Appointment
                        </a>
                        <a href="<?php echo e(route('contact')); ?>" class="btn btn-outline-custom btn-lg w-100">
    ...
    <section class="section-padding" style="background: var(--ashlocs-light);">
        <div class="container">
            ...
            <div class="row g-4">
                <?php $__currentLoopData = $relatedServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $relatedService): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="<?php echo e(($index + 1) * 100); ?>">
                    <div class="service-card">
                        <div class="service-icon">
                            <i class="<?php echo e($relatedService->icon); ?>"></i>
                        </div>
                        <h3 class="service-title"><?php echo e($relatedService->title); ?></h3>
                        <p class="service-description"><?php echo e(Str::limit($relatedService->description, 100)); ?></p>
                        <?php if($relatedService->slug): ?>
                        <a href="<?php echo e(route('services.show', $relatedService->slug)); ?>" class="btn btn-outline-custom btn-sm">Learn More</a>
                        <?php endif; ?>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center" data-aos="fade-up">
                    <h2>Ready to Book Your <?php echo e($service->title); ?> Service?</h2>
                    <p>Experience professional hair care that elevates your crown. Book your appointment today!</p>
                    <a href="<?php echo e(route('booking.index')); ?>?service=<?php echo e($service->id); ?>" class="btn btn-white-custom btn-lg">
                        <i class="fas fa-calendar-check me-2"></i>Book an Appointment
                    </a>
                </div>
            </div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/metrohealth/resources/views/services/show-redesign.blade.php ENDPATH**/ ?>