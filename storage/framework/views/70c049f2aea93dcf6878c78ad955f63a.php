                    ...
                    <div class="team-card">
                        <div class="team-image">
                            ...
                            <div class="team-overlay">
                                <a href="<?php echo e(route('team.show', ['slug' => Str::slug($member['name'])])); ?>" class="view-profile-btn">
                                    <i class="fas fa-user"></i> View Profile
                                </a>
                            </div>
                        </div>
                        <div class="team-info">
                            <h4 class="team-name"><?php echo e($member['name']); ?></h4>
                            <p class="team-position"><?php echo e($member['position']); ?></p>
                            <p class="team-specialty"><?php echo e($member['specialty']); ?></p>
                            <a href="<?php echo e(route('team.show', ['slug' => Str::slug($member['name'])])); ?>" class="btn-view-profile">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/metrohealth/resources/views/our-team-redesign.blade.php ENDPATH**/ ?>