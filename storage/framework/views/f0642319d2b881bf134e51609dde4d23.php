...
<body>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="booking-form-container" data-aos="fade-up">
                        ...
                        <form action="<?php echo e(route('clinic-appointments.store')); ?>" method="POST" id="appointmentForm">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="row mb-4">
                                <div class="col-12">
                                    ...
                                    <select class="form-select" id="service_name" name="service_name" required>
                                        ...
                                        <option value="<?php echo e($serviceName); ?>" data-days="<?php echo e(json_encode($schedule['days'])); ?>" data-fee="<?php echo e($schedule['fee']); ?>" data-time-range="<?php echo e($schedule['time_range']); ?>">
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="full_name" name="full_name" placeholder="Enter your full name" value="<?php echo e(old('full_name')); ?>" required>
                                </div>
                                <div class="col-md-6">
                                    <label for="phone" class="form-label required-field">Phone Number</label>
                                    <input type="tel" class="form-control" id="phone" name="phone" placeholder="+233 XX XXX XXXX" value="<?php echo e(old('phone')); ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="email" class="form-control" id="email" name="email" placeholder="your.email@example.com" value="<?php echo e(old('email')); ?>" required>
                                </div>
                                <div class="col-md-6">
                                    <label for="address" class="form-label required-field">Location Address</label>
                                    <input type="text" class="form-control" id="address" name="address" placeholder="Your address" value="<?php echo e(old('address')); ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control" id="notes" name="notes" rows="4" placeholder="Any special requirements or information we should know..."><?php echo e(old('notes')); ?></textarea>
                            </div>
    ...
    <script>
        ...
        const serviceSchedules = <?php echo json_encode($services, 15, 512) ?>;
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/metrohealth/resources/views/clinic-appointments/index.blade.php ENDPATH**/ ?>