...
unset($__errorArgs, $__bag); ?>" required><?php echo e(old('excerpt')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="content" rows="15" class="form-control <?php $__errorArgs = ['content'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('author', auth()->user()->name ?? '')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('category')); ?>" placeholder="e.g., Health News, Medical Research">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="datetime-local" name="published_at" class="form-control <?php $__errorArgs = ['published_at'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        <input type="checkbox" name="published" class="form-check-input" id="published" value="1" <?php echo e(old('published', true) ? 'checked' : ''); ?>>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/metrohealth/resources/views/admin/blog/create.blade.php ENDPATH**/ ?>