...
<body>
        ...
        <div class="container">
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="<?php echo e(($index % 3) * 100); ?>">
                    <div class="gallery-item" onclick="openLightbox(<?php echo e($index); ?>)" style="cursor: pointer;">
                        <div class="gallery-image">
                            ...
                            <div class="gallery-overlay">
                                <div class="gallery-info">
                                    ...
                                    <h4 class="gallery-title"><?php echo e($item['title']); ?></h4>
    ...
    <script>
        ...
        const galleryImages = <?php echo json_encode(array_values($galleryItems), 15, 512) ?>;
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/metrohealth/resources/views/our-gallery-redesign.blade.php ENDPATH**/ ?>