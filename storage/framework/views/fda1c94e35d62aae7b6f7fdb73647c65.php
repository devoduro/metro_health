                ...
                <div class="col-lg-8" data-aos="fade-right">
                    <div class="service-detail-content">
                        ...
                        <div class="service-image mb-5" style="border-radius: 25px; overflow: hidden; box-shadow: 0 20px 50px rgba(0, 0, 0, 0.15); position: relative;">
                            <img src="https://images.unsplash.com/photo-1551190822-a9333d879b1f?w=1200" 
                                 alt="General Surgery at Metro Health" 
                                 class="w-100" 
                ...
                <div class="col-lg-4" data-aos="fade-left">
                    ...
                    <div class="services-menu mb-4" style="background: white; border-radius: 20px; padding: 30px; box-shadow: 0 5px 20px rgba(0, 0, 0, 0.08);">
                        ...
                        <div class="services-list">
                            ...
                            <a href="<?php echo e(route('services.general-surgery')); ?>" class="service-link active" style="display: flex; align-items: center; padding: 12px 15px; margin-bottom: 8px; border-radius: 10px; text-decoration: none; background: #f3e5f5; border-left: 3px solid #a8207a; transition: all 0.3s ease;">
                                <i class="fas fa-user-md me-3" style="color: #a8207a; font-size: 1.1rem;"></i>
                                <span style="color: #2d3e50; font-weight: 600;">General Surgery</span>
                            </a>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/metrohealth/resources/views/services/general-surgery.blade.php ENDPATH**/ ?>